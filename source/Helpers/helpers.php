...
function textError($errcode)
{
    ...
    $errors = array(
        ...
        '-34' => 'Código Administrativo ou Senha inválidos. 12/16 DEENC – Departamento de Encomendas Revisão 25/09/2019',
        '-35' => 'Senha incorreta.',
        ...
        'app1' => 'Código de serviço inválido para clientes sem contrato com o Correios',
        'app2' => 'Obrigatório informar o diâmetro do rolo/prisma',
        'app3' => 'No formato envelope, o valor máximo informado no peso é de 1kg',
        'app4' => 'CEP de origem com tamanho inválido (Tamanho correto: 8)',
        'app5' => 'CEP de destino com tamanho inválido (Tamanho correto: 8)'
    );
